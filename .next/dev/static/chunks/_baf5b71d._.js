...
const reviewAPI = {
    ...
    getLawyerReviews: (lawyerId)=>api.get(`/reviews/lawyer/${lawyerId}`)
};
...
function LoginPage() {
    ...
    const { setAuth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const [showPassword, setShowPassword] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [selectedRole, setSelectedRole] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("CLIENT");
        ...
        try {
            ...
            if (user.role === "LAWYER") {
                ...
                if (user.verification_status && user.verification_status !== "APPROVED") {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("Logged in. Your lawyer verification is pending.");
                    router.push("/auth/verify-pending");
                    return;
                }
                // If the user selected CLIENT by mistake, gently inform them
                if (selectedRole === "CLIENT") {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("You logged in as a Lawyer. Redirecting to Lawyer Dashboard.");
                }
            ...
            if (user.role === "CLIENT") {
                if (selectedRole === "LAWYER") {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("You logged in as a Client. If you intended to login as a Lawyer, please register or use the lawyer login option.");
                }
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(error.response?.data?.message || "Login failed. Please check credentials.");
        } finally{
            setIsLoading(false);
        }
    }
...
_s(LoginPage, "WIChvv+KA8AUuCjbZolUNbEjU+E=", false, function() {
    return [
...
//# sourceMappingURL=_baf5b71d._.js.map